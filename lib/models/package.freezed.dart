...
abstract class $PackageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String author, Color color, Widget icon});
}
...
class _$PackageImpl implements _Package {
  ...
  @override
  String toString() {
    return 'Package(name: $name, author: $author, color: $color, icon: $icon)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, author,
      const DeepCollectionEquality().hash(color), icon);
...
abstract class _Package implements Package {
  const factory _Package(
      ...
      required final Widget icon}) = _$PackageImpl;
